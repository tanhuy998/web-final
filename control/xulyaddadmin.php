...
<?php 
    ...
    {
        echo "Vui lòng nhập đầy đủ thông tin. <a href='http://localhost/final/view/add_admin.php/'>Trở lại</a>";
        exit;
    }
    ...
    if($row['TAIKHOAN']){
    	echo "Tên đăng nhập này đã có người dùng. Vui lòng chọn tên đăng nhập khác. <a href='http://localhost/final/view/add_admin.php/'>Trở lại</a>";
        exit;
    }
    ...
    if($row['EMAIL']){
    	echo "Gmail đã được sử dụng, vui lòng nhập gmail khác ! cảm ơn!. <a href='http://localhost/final/view/add_admin.php//'>Trở lại</a>";
        exit;
    }
    ...
    if($row['SDT']){
    	echo "Số điện thoại đã được sử dụng, vui lòng nhập số điện thoại khác ! cảm ơn!. <a href='http://localhost/final/view/add_admin.php/'>Trở lại</a>";
        exit;
    }
    ...
    $sql = "INSERT INTO account(TAIKHOAN,MATKHAU,LOAITK) VALUES ('$tentaikhoan',' $matkhau','1')";
    $connect->query($sql);
