                                    ...
                                    <div class="col-1">
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <form method="POST" enctype="multipart/form-data" action="#">
                                                <label class="" for="billing_first_name">Tên Sản phẩm <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="" placeholder="" id="billing_first_name" name="product_name" class="input-text ">

                                                <label class="" for="billing_first_name">Giá <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="" placeholder="" id="billing_first_name" name="product_price" class="input-text ">

                                                <label class="" for="billing_first_name">Mô tả <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="" placeholder="" id="billing_first_name" name="product_description" class="input-text ">
                                            ...
                                            <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                                <label class="" for="billing_last_name">Mô tả <abbr title="required" class="required">*</abbr>
                                                </label>
                                            ...
                                            <p id="billing_company_field" class="form-row form-row-wide">
                                                <label class="" for="billing_company">Giá</label>
