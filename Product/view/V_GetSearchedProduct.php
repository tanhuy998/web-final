...
<div class="header-area">
    ...
    <div class="single-product-area">
        ...
        if($contain)
        {
            foreach($res as $eachPro)
            {
            ?>
             <h3> <?php echo $eachPro->TENSANPHAM; ?> </h3>
                <img src="<?php echo "../../../Images/".$eachPro->DUONGDAN ?>"  width='180' height='180' />
                 <p><b> <?php echo $eachPro->GIA; ?> </b>
                <?php echo $eachPro->TENTAG; ?>
                </p> 
            <?php }  
        }
        else
            echo "<script>alert('Không tìm thấy sản phẩm, xin mời kiểm tra lại !')</script>";
	    ?>
