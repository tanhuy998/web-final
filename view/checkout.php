                    ...
                    <div class="product-content-right">
                        <div class="woocommerce">
                            ...
                            <form enctype="multipart/form-data" action="http://localhost/final/control/C_Checkout-Process.php" class="checkout" method="post" name="checkout">
                                ...
                                <h3 id="order_review_heading">Các sản phẩm bạn mua</h3>
                                    ...
                                    <table class="shop_table">
                                        ...
                                        <tbody>
                                            <?php
                                                foreach($productCartList as $product) {
                                                    $id = $product['ID'];
                                                    $qty = $quantity["$id"];
                                                    $total = intval($product['GIA']) * intval($qty);
                                                    $cartSubtotal += $total;
                                                    echo "<tr class=\"cart_item\">";
                                                    echo "<td class=\"product-name\">".$product['TENSANPHAM']."<strong class=\"product-quantity\">× $qty</strong> </td>";
                                                    echo "<td class=\"product-total\"><span class=\"amount\">".number_format($total)." VNĐ</span> </td>";
                                                    echo "</tr>";
                                                }
                                            ?>
                                        </tbody>
                                        <tfoot>
                                            ...
                                            <tr class="cart-subtotal">
                                                <th>Tổng tiền</th>
                                                <td><span class="amount"><?php echo number_format($cartSubtotal);?> VNĐ</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="order-total">
                                                ...
                                                <td><strong><span class="amount"><?php echo number_format($cartSubtotal);?> VNĐ</span></strong> </td>
                                            </tr>
