                ...
                <?php
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo        "<a href=\"single-product.php?id=".$row['ID']."\"><img src=\"img/product-2.jpg\" alt=\"\"></a>";
                            echo   "</div>";
                            echo    "<h2><a href=\"single-product.php?id=".$row['ID']."\">".$row['TENSANPHAM']."</a></h2>";
                            echo    "<div class=\"product-carousel-price\">";
                            echo        "<ins>".$row['GIA']."</ins>";
                            echo     "</div>";
                                
                            echo    "<div class=\"product-option-shop\">";
                            echo        "<a class=\"add_to_cart_button\" data-quantity=\"1\" data-product_sku=\"\" data-product_id=\"70\" rel=\"nofollow\" href=\"shop.php?add-to-cart=".$row['ID']."\">Thêm vào giỏ</a>";
                            echo    "</div></div> </div>";
                        }
                    }
                    else echo "ERROR";
